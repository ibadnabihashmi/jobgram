...
request('http://www.linkedin.com/jobs/search?sortBy=DD&locationId=pk:0&start=0&count=25&applyLogin=false', function(error, response, body) {
    if(error) {
    ...
    var jobsList = [];
    $('.job-title-link').each(function (element) {
        jobsList.push({
